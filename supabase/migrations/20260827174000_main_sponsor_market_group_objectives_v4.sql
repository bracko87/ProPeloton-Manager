-- Main sponsor objective preview V4.
-- Objectives follow the existing country marketing groups.
-- Same-group club/sponsor: all targets come from the shared group when possible.
-- Different groups: targets alternate approximately 50/50 between club and sponsor groups.
-- Stage-specific objectives gracefully fall back to race top-5/top-10/win inside the same market group.

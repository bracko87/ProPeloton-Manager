...
'Creates National Championship races only when two distinct suitable host-country routes exist. Uses country flag branding and profile point data only; source race/stage names, logos, branded profile images, KOM gates and intermediate sprints are not reused.';

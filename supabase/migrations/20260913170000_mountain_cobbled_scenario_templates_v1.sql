...
-- Extends the already-authoritative Flat/Hilly scenario reservation contract to
-- Mountain V1 and Cobbled V1 while preserving existing selections and history.
...
begin
  ...
  return jsonb_build_object(
    ...
    'race_repeat_allowed_after_exhaustion',v_allow_race_repeat,
    'day_repeat_allowed_after_exhaustion',v_allow_day_repeat
  );
end;
$$;

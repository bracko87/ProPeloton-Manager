-- Road Scenario Template System V1 expansion
-- Extends the Flat V1 reservation/history contract to Hilly V1 without
-- changing already-reserved flat selections.
...
alter table public.race_engine_scenario_runs
  ...
  check (scenario_type in ('flat','hilly'));

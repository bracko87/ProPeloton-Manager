...
'Returns completed stage winners plus GC, mountain and points classification leaders from the current and previous in-game day for the Overview results carousel. Available to every authenticated player.';

...
export interface ReplayRiderFrame {
  ...
  readonly gapToLeaderSeconds:
    number | null

  readonly gapToPreviousRiderSeconds:
    number | null

  readonly position: number | null

  readonly staminaPercent:
    number | null

  readonly fatiguePercent:
    number | null
...
export interface ReplayGroupFrame {
  ...
  readonly gapToPreviousGroupSeconds:
    number | null

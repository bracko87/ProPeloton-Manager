...
register(
  'Your Developing Team is a Premium-only second team for young riders who are not yet ready for the First Squad but can still race in assigned competitions. An active Premium membership is required to create and use the Developing Team. First activation costs 100 coins and each seasonal renewal costs 100 coins. The U23 Head Coach is also Premium-only. If Premium expires, Developing Team access is paused but the team, riders, contracts, results and history remain stored. Riders can only move between the First Squad and Developing Team during the normal movement windows.',

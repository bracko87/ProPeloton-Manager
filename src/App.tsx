...
import DeterministicEngineModeDiagnostic from './pages/dev/DeterministicEngineModeDiagnostic'
import DeterministicShadowGateDiagnostic from './pages/dev/DeterministicShadowGateDiagnostic'
  ...
  */
  ...
  ```
     ...
     <Route
       ...
       element={<RioStage1ShadowDiagnostic />}
     />
     ...
     <Route
       path="/dev/deterministic-engine-mode"
       element={
         <DeterministicEngineModeDiagnostic />
       }
     />

     <Route
       path="/dev/deterministic-shadow-gate"
       element={
         <DeterministicShadowGateDiagnostic />
       }
     />

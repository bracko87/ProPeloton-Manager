...
const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    "details": [
      ...
      "A race crash can end with no lasting injury, a minor injury, a moderate injury or a major injury.",
      "Minor race injuries are short persistent health cases. The rider can still be selected, but remains not fully fit and can lose race sharpness while recovering.",
      "Moderate race injuries also leave the rider selectable, but the medical case and recovery effects are stronger and can affect the following stages or race days.",
      "Major race injuries create genuine unavailability. The rider can abandon the current stage and can be blocked from later stages or races until recovery.",
      ...
      "Race health outcomes are written into the real squad state after the stage; they are not replay-only events.",
      "Hard training and heavy race calendars both increase overload risk.",
      "Medical staff and recovery systems can reduce risk or improve recovery."
    ],
    "tips": [
  ...
  },
  {
    ...
    "facts": [
      ...
      },
      {
        ...
        "value": "100 coins / 100 coins each season"
      },
      {
  ...
  },
  {
    ...
    "details": [
      ...
      "Health and race load matter too: a rider who is injured or not fully fit may lose sharpness or need lighter work even when the normal training plan would otherwise be suitable."
    ],
    "tips": [
  ...
  },
  {
    ...
    "details": [
      ...
      "Equipment that is actually used by your riders in a stage loses condition after that stage. Wear is linked to race use and distance, so repeated racing gradually creates maintenance and replacement decisions."
    ],
    "tips": [
  ...
  },
  {
    ...
    "details": [
      ...
      "Support assets that are actually used for a race can lose condition after the stage. Repeated race use therefore increases the need for repairs and replacement planning."
    ],
    "tips": [
  ...
  },
  {
    ...
    "details": [
      ...
      "Crashes, fatigue and health outcomes shown by the official replay are part of the same stage calculation. When the stage is finalized, persistent consequences such as injuries, not-fully-fit status and post-stage fatigue carry into the real squad state.",
      "A replay does not create a second result after the fact; it explains the race that was already calculated."
    ],
    "tips": [
  ...
  {
    "id": "race-engine-basics",
    "category": "Calendar and Races",
    "title": "How Race Results Are Decided",
    "subtitle": "What the race engine considers without exposing internal formulas.",
    "overview": "There is no single number that guarantees victory. The official race calculation combines rider quality, route fit, current condition, preparation, tactics and what happens dynamically during the stage.",
    "facts": [
      { "label": "Rider factors", "value": "Skills, role, fatigue, race sharpness, health, morale and remaining energy" },
      { "label": "Preparation factors", "value": "Stage tactics, equipment, supplies, staff and race-support assets" },
      { "label": "Race factors", "value": "Terrain, weather, groups, attacks, chasing, breakaways, incidents and finish type" }
    ],
    "details": [
      "The strongest overall rider is not automatically the winner. Specialist skills matter differently on flat, hilly, mountain, cobbled and time-trial stages.",
      "Fatigue, health, race sharpness and energy can make two riders with similar skills perform very differently on the day.",
      "Your Stage Plan influences how riders spend energy and react to the race. Roles and tactics can protect a leader, support a sprint, chase, attack or target a breakaway.",
      "Equipment, supplies, staff and selected support assets can improve preparation, reliability, recovery or efficiency when they are available and used.",
      "The race itself remains dynamic. Breakaways can succeed or be caught, chase resources can be spent, groups can split, and crashes or mechanical incidents can change the outcome.",
      "The replay and official result come from the same calculation, so what you see in the replay explains the stored result rather than generating a new one."
    ],
    "tips": [
      "Choose riders for the route, not only by overall rating.",
      "Arrive at important races with manageable fatigue and complete Stage Plans."
    ],
    "relatedLinks": [
      { "label": "Race Preparation", "to": "/dashboard/race-preparation" },
      { "label": "Calendar", "to": "/dashboard/calendar" }

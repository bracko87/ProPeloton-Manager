        ...
        <>
          ...
          {workspace && tab === 'finance' ? (
            <PremiumFinancialSimulator
              clubId={clubId}
              snapshot={{
                balance: workspace.finance.balance,
                weeklyIncome: workspace.finance.weekly_income,
                weeklyExpenses: workspace.finance.weekly_expenses,
              }}
              assumePremium
              showHeaderLink
              className="mt-0"
